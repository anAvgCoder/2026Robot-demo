...
public class VisionConstants {
  ...
  private static final double LEFT_CAMERA_PITCH = Units.degreesToRadians(22.5);
  private static final double LEFT_CAMERA_YAW = Units.degreesToRadians(45); // 35.5

  private static final double RIGHT_CAMERA_PITCH = Units.degreesToRadians(22.5);
  private static final double RIGHT_CAMERA_YAW = Units.degreesToRadians(-45.0);

  public static final Transform3d LEFT_ROBOT_TO_CAMERA =
      new Transform3d(
          new Translation3d(
              Units.inchesToMeters(12.7914),
              Units.inchesToMeters(12.7914),
              Units.inchesToMeters(14.0578)),
  ...
  public static final Matrix<N3, N1> kMultiTagStdDevs = VecBuilder.fill(0.3, 0.3, 2);
}
