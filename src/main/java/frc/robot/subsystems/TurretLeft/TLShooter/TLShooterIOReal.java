...
public class TLShooterIOReal implements TLShooterIO {
  ...
  public TLShooterIOReal() {
    super();
    motor = new SparkFlex(TLShooterConstants.CanId, MotorType.kBrushless);
    ...
    sparkConfig
        ...
        .smartCurrentLimit(TLShooterConstants.shooterMotorCurrentLimit)
        .voltageCompensation(12.0);
    sparkConfig
        .closedLoop
        .pid(TLShooterConstants.kP, 0.0, 0.0, ClosedLoopSlot.kSlot0)
        .outputRange(-1, 1, ClosedLoopSlot.kSlot0);
    sparkConfig
        .closedLoop
        .feedForward
        .kS(0.0, ClosedLoopSlot.kSlot0)
        .kV(TLShooterConstants.kV, ClosedLoopSlot.kSlot0);
    sparkConfig
        .signals
