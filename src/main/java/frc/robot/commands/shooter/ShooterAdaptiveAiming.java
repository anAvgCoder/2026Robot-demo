 ...
 * control.
 */
public class ShooterAdaptiveAiming extends Command {
  private RotaterIO rotaterIORight = null;
  private HoodIO hoodIORight = null;
  private ShooterIO shooterIORight = null;
  private RotaterIO rotaterIOLeft = null;
  private HoodIO hoodIOLeft = null;
  private ShooterIO shooterIOLeft = null;
  private Drive drive;
  ...
  private Transform3d turretOffset(boolean isRightTurret) {
    double xMeters = Units.inchesToMeters(6.5 + QuestNavConstants.ROBOT_TO_QUEST_INCHES_X_DOUBLE);
